/**
 * post-30 검증
 * 실행: node scripts/test-blog-post30.mjs
 */
...
const OUT = "screenshots/blog-post30";
...
async function main() {
  ...
  await page.goto(`${BASE}/blog/post-30.html`, { waitUntil: "domcontentloaded" });
  ...
  const checks = await page.evaluate(() => ({
    ...
    ctaPost29: !!document.querySelector('a[href="post-29.html"]'),
  ...
  const blogIndexChecks = await page.evaluate(() => ({
    ...
    has30: !!document.querySelector('a[href="post-30.html"]'),
  }));
  ...
  const homeChecks = await page.evaluate(() => ({
    ...
    secondBlog: document.querySelectorAll(".blog-preview-section .blog-grid a.blog-card")[1]?.getAttribute("href"),
    has30: !!document.querySelector('.blog-preview-section a[href="/blog/post-30.html"]'),
  ...
  const sitemapOk =
    sitemap.includes("post-30.html") && sitemap.includes("2026-07-06");
  ...
  const pass =
    ...
    checks.faq &&
    checks.dateOk &&
    blogIndexChecks.first === "post-30.html" &&
    blogIndexChecks.has30 &&
    homeChecks.firstBlog === "/blog/post-30.html" &&
    homeChecks.secondBlog === "/blog/post-29.html" &&
    homeChecks.has30 &&
    homeChecks.statPosts === "30" &&
