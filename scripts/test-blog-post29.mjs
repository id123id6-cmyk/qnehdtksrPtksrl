/**
 * post-29 검증
 * 실행: node scripts/test-blog-post29.mjs
 */
...
const OUT = "screenshots/blog-post29";
...
async function main() {
  ...
  await page.goto(`${BASE}/blog/post-29.html`, { waitUntil: "domcontentloaded" });
  ...
  const checks = await page.evaluate(() => ({
    ...
    ctaPost30: !!document.querySelector('a[href="post-30.html"]'),
    ctaPost24: !!document.querySelector('a[href="post-24.html"]'),
    ctaSubscription: !!document.querySelector('a[href="/tools/subscription-calculator/"]'),
    tables: document.querySelectorAll(".post-table").length,
    faq: document.body.innerText.includes("Q1."),
    dateOk: document.querySelector('time[datetime="2026-07-06"]') !== null,
  }));

  await page.goto(`${BASE}/blog/`, { waitUntil: "domcontentloaded" });
  const blogIndexChecks = await page.evaluate(() => ({
    first: document.querySelector("#blog-grid a.blog-card")?.getAttribute("href"),
    has29: !!document.querySelector('a[href="post-29.html"]'),
  }));
  ...
  const homeChecks = await page.evaluate(() => ({
    ...
    has29: !!document.querySelector('.blog-preview-section a[href="/blog/post-29.html"]'),
  ...
  const sitemapOk =
    sitemap.includes("post-29.html") && sitemap.includes("2026-07-06");
  ...
  const pass =
    ...
    checks.ctaPost30 &&
    checks.ctaPost24 &&
    checks.ctaSubscription &&
    checks.tables >= 2 &&
    checks.faq &&
    checks.dateOk &&
    blogIndexChecks.first === "post-29.html" &&
    blogIndexChecks.has29 &&
    homeChecks.firstBlog === "/blog/post-29.html" &&
    homeChecks.has29 &&
    homeChecks.statPosts === "29" &&
