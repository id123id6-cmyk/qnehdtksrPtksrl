/**
 * post-27 검증
 * 실행: node scripts/test-blog-post27.mjs
 */
...
const OUT = "screenshots/blog-post27";
...
async function main() {
  ...
  await page.goto(`${BASE}/blog/post-27.html`, { waitUntil: "domcontentloaded" });
  ...
  const checks = await page.evaluate(() => ({
    ...
    ctaPost28: !!document.querySelector('a[href="post-28.html"]'),
  ...
  const blogIndexChecks = await page.evaluate(() => ({
    ...
    has27: !!document.querySelector('a[href="post-27.html"]'),
  }));
  ...
  const homeChecks = await page.evaluate(() => ({
    ...
    has27: !!document.querySelector('.blog-preview-section a[href="/blog/post-27.html"]'),
  ...
  const sitemapOk =
    sitemap.includes("post-27.html") && sitemap.includes("2026-07-03");
  ...
  const pass =
    ...
    checks.faq &&
    checks.dateOk &&
    blogIndexChecks.first === "post-27.html" &&
    blogIndexChecks.has27 &&
    homeChecks.firstBlog === "/blog/post-27.html" &&
    homeChecks.has27 &&
    homeChecks.statPosts === "27" &&
